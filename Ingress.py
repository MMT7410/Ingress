...
|______________________________________________________________________________|
|                                                                              |
|      Welcome to "Ingress"- The 22 electronic Army contract Agency            |
|______________________________________________________________________________|
       ...
       messenger v 1.0 | AsadUllah                 

"""

def sigint_handler(signum, frame):
    print '\n user interrupt ! shutting down'
    print "[info] shutting down Ingress \n\n"
    sys.exit()	
...
def chat_client():
    if(len(sys.argv) < 5) :
        print 'Usage : python ingress.py <hostname> <port> <password> <nick_name>'
        sys.exit()
